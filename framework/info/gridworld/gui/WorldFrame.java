...
public class WorldFrame<T> extends JFrame
{
        ...
        ActionListener listener )
    {
        ...
        try
        {
            ...
            if ( accel.startsWith( metaPrefix ) )
            {
                ...
                KeyStroke key = KeyStroke.getKeyStroke( KeyStroke.getKeyStroke( accel.substring( metaPrefix.length() ) )
                    .getKeyCode(),
                    menuMask );
    ...
    public class GUIExceptionHandler
    {
        public void handle( Throwable e )
        {
            ...
            pane.createDialog( WorldFrame.this, e.toString() )
                .setVisible( true );
